...
execute in battlepaint:battlepaint run tellraw @a[tag=battlepaint] {"text":"玩家 [橙色] ","color":"gold","extra":[{"selector":"@s"},{"text":" 加入了油漆大战","color":"gold"}]}
tellraw @s {"text":"你已成功加入橙色队伍","color":"gold","bold":true}
...
fill ~-1 7 ~-1 ~1 7 ~1 minecraft:orange_concrete
