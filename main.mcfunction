...
execute in battlepaint:battlepaint run tellraw @a[tag=battlepaint] {"text":"玩家 [白色] ","color":"white","extra":[{"selector":"@s"},{"text":" 加入了油漆大战","color":"gold"}]}
tellraw @s {"text":"你已成功加入白色队伍","color":"white","bold":true}
...
fill ~-1 7 ~-1 ~1 7 ~1 minecraft:white_concrete
