...
execute in battlepaint:battlepaint run tellraw @a[tag=battlepaint] {"text":"玩家 [黄色] ","color":"yellow","extra":[{"selector":"@s"},{"text":" 加入了油漆大战","color":"gold"}]}
tellraw @s {"text":"你已成功加入黄色队伍","color":"yellow","bold":true}
...
fill ~-1 7 ~-1 ~1 7 ~1 minecraft:yellow_concrete
