...
execute in battlepaint:battlepaint run tellraw @a[tag=battlepaint] {"text":"玩家 [粉色] ","color":"light_purple","extra":[{"selector":"@s"},{"text":" 加入了油漆大战","color":"gold"}]}
tellraw @s {"text":"你已成功加入粉色队伍","color":"light_purple","bold":true}
...
fill ~-1 7 ~-1 ~1 7 ~1 minecraft:pink_concrete
