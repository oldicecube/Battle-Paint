...
execute in battlepaint:battlepaint run tellraw @a[tag=battlepaint] {"text":"玩家 [紫色] ","color":"dark_purple","extra":[{"selector":"@s"},{"text":" 加入了油漆大战","color":"gold"}]}
tellraw @s {"text":"你已成功加入紫色队伍","color":"dark_purple","bold":true}
...
fill ~-1 7 ~-1 ~1 7 ~1 minecraft:purple_concrete
