...
execute in battlepaint:battlepaint run tellraw @a[tag=battlepaint] {"text":"玩家 [红色] ","color":"red","extra":[{"selector":"@s"},{"text":" 加入了油漆大战","color":"gold"}]}
tellraw @s {"text":"你已成功加入红色队伍","color":"red","bold":true}
...
fill ~-1 7 ~-1 ~1 7 ~1 minecraft:red_concrete
